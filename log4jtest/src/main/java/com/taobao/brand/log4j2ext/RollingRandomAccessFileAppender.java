...
public class RollingRandomAccessFileAppender extends
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
        ...
        public RollingRandomAccessFileAppender build() {
            ...
            if (strategy == null) {
                ...
                LOGGER.error(
                    "RollingFileAppender '{}': When no file name is provided a DirectFilenameRolloverStrategy must be"
                        + " configured");
                return null;
            }
            ...
            return createAppenderInstance(name, layout, getFilter(), manager, fileName, filePattern,
                isIgnoreExceptions(), immediateFlush, bufferSize,
                advertise ? getConfiguration().getAdvertiser() : null);
        }

        protected RollingRandomAccessFileAppender createAppenderInstance(final String name,
            ...
            return new RollingRandomAccessFileAppender(name, layout, filter, manager, fileName, filePattern,
                ignoreExceptions, immediateFlush, bufferSize,
                advertiser);
        }
    ...
    protected RollingRandomAccessFileAppender(final String name, final Layout<? extends Serializable> layout,
     ...
     * @param append           If true, events are appended to the file. If false, the file is overwritten when opened.
     *                         Defaults to "true"
